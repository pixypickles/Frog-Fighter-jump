(() => {
  ...
  function startStoryMode(){
    ...
    showStoryNarrative([
      ...
      'カエルは蓮の葉へ着地すると、またすぐ空へ跳び上がった。\n\nしばらく眺めているうちに、一郎はふと思う。\n\n「いや、待てよ……」\n\n「あいつらはあいつらで、厳しい世界を生き抜いているのかもしれない」',
      '河津一郎は、池に浮かぶ蓮の葉を見つめながら妄想し始めた――。'
      ...
      if(!playerWon && storyLosses>=4){
        ...
        if(playerWon){
          ...
          showStoryNarrative([
            '激闘の末、ベルゼブブさんは倒れた。\n\n……\n\n池を眺めていた河津一郎は、我に返った。',
            '河津一郎「……俺も、負けちゃいられないな」\n\n一郎は立ち上がった。\n\nそして――\n\n池へ向かって、高く跳んだ。\n\nぴょーん。',
            '河津一郎は水へ飛び込む――ことなく、そのまま大きな蓮の葉へ着地した。\n\n葉が沈むより早く、力強い後ろ脚でもう一度空へ跳び上がる。\n\nその跳躍力は、池のどのカエルにも負けていなかった。',
            '河津一郎――いや、\n\nカワズさん参戦！！'
          ],()=>{restartButton.hidden=false;});
        }else{
